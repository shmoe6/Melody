...
object ItemTooltipHandler {

    val maxEnchantsSword: HashSet<String> = hashSetOf("Bane of Arthropods VII", "Champion X", "Cleave VI",
    ...
    val maxEnchantsBow: HashSet<String> = hashSetOf("Chance V", "Cubism VI", "Divine Gift III", "Dragon Hunter V",
    ...
    private fun String.stripControlCodes(): String = StringUtils.stripControlCodes(this)
    ...
    fun onTooltip(event: ItemTooltipEvent) {
        ...
        for (line in event.toolTip.reversed()) {
            ...
            val strippedLine = line.stripControlCodes()
